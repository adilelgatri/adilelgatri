 ...
 if(rech(num)==1)
   {
	  ...
	  do{
        fscanf(F,"\n");
	  	fscanf(F,"%f:%d:%d:%d-%d-%d:%d-%d-%d:%d",&Co.numcontrat,&Co.idvoiture,&Co.idclient,&Co.debut.jour,&Co.debut.mois,&Co.debut.annes,&Co.fin.jour,&Co.fin.mois,&Co.fin.annes,&Co.cout);
